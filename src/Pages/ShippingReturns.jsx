  ...
  return (
    <div className="bg-white text-gray-800 min-h-screen py-16 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4 text-center">Shipping & Returns</h1>
        ...
        <div className="space-y-12">
          {/* Shipping Section */}
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-4 flex items-center md:items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Fast & secure delivery</p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-4 flex items-center md:items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Returns & Exchanges</h2>
                <p className="text-xs text-gray-400 mt-1">Hassle-free 30-day window</p>
              </div>
            </div>
            <div className="md:col-span-8 space-y-4 text-sm text-gray-600 leading-relaxed">
              <p>
